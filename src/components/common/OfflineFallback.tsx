    ...
    <div className='offline-fallback'>
      <div className='offline-fallback__container'>
        ...
        <p className='offline-fallback__description'>
          It looks like you've lost your internet connection. Some features may be unavailable while
          offline.
        </p>

        <div className='offline-fallback__actions'>
          <button className='btn btn--primary btn--medium' onClick={handleRetry}>
            <svg
              width='20'
              height='20'
              viewBox='0 0 24 24'
          ...
          <button className='btn btn--ghost btn--medium' onClick={handleGoHome}>
            Go to Home
          </button>
        </div>
