...
import { SIDEBAR_STORAGE_KEY, MAIN_NAV_ITEMS, SETTINGS_NAV_ITEMS } from '../../mocks/sidebar'
...
export default function SidebarLayout({ children, pageClass = '', navbarContent }: SidebarLayoutProps) {
    ...
    <div className={`home-page ${pageClass}`}>
      ...
      >
        ...
        <div className='sidebar-footer'>
          ...
          <p className='sidebar-copyright'>&copy; 2026 Cadlix. All rights reserved.</p>
        </div>
      </aside>
