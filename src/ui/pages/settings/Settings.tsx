...
import { SECTIONS, DEFAULT_SETTINGS } from '../../../mocks/settings'
...
export default function Settings() {
  ...
  function set<S extends keyof SettingsState>(section: S, key: keyof SettingsState[S], value: SettingsState[S][keyof SettingsState[S]]): void {
    setSettings(prev => ({
      ...prev,
  ...
  function renderPlayback() {
    ...
    return (
      <>
        <SettingsRow label='Video Quality' description='Default streaming quality for all content'>
          <select
            className='settings-select'
            value={s.quality}
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => set('playback', 'quality', e.target.value)}
          >
        ...
        >
          <select
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => set('playback', 'subtitleLang', e.target.value)}
          >
      ...
      <>
        ...
        >
          <select
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => set('privacy', 'profileVisibility', e.target.value)}
          >
  ...
  function renderAppearance() {
    ...
    return (
      <>
        <SettingsRow label='Interface Language' description='Language used throughout the platform'>
          <select
            className='settings-select'
            value={s.language}
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => set('appearance', 'language', e.target.value)}
          >
            <option value='en'>English</option>
            <option value='fr'>French</option>
            <option value='es'>Spanish</option>
        ...
        <SettingsRow label='Region' description='Affects available content and local pricing'>
          <select
            className='settings-select'
            value={s.region}
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => set('appearance', 'region', e.target.value)}
          >
        ...
        >
          <select
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => set('appearance', 'subtitleSize', e.target.value)}
          >
      ...
      <div className='settings-page'>
        <div className='settings-header'>
          ...
          <p className='settings-subtitle'>
            Manage your playback, privacy, and account preferences
          </p>
        </div>
        ...
        <div className='settings-layout'>
          ...
          <div className='settings-panel'>
            ...
            <div className='settings-rows'>{sectionRenderers[activeSection]?.()}</div>
          </div>
        </div>
      </div>
    </SidebarLayout>
