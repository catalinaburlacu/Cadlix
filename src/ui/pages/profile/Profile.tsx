...
export default function Profile() {
  ...
  const [showBookmarks, setShowBookmarks] = useState<string>('yes')
  const [gender, setGender] = useState<string>('female')
  const [location, setLocation] = useState<string>('')
  const [timezone, setTimezone] = useState<string>('default-gmt-plus-3')
  ...
  const handleDeleteProfile = useCallback(async () => {
    ...
    const typedConfirmation = window.prompt('Confirmare 2/2: scrie exact STERGE pentru a continua.')
  ...
  const profileSubnav = (
    <nav className='page-subnav' aria-label='Account navigation'>
      <NavLink
        ...
        className={({ isActive }) => `page-subnav-link${isActive ? ' active' : ''}`}
      >
        Profile
      </NavLink>
      <NavLink
                ...
                <div className='edit-grid'>
                  ...
                  <div className='edit-field'>
                    ...
                    <input
                      ...
                      type='email'
                      value={gravatarEmail}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setGravatarEmail(e.target.value)}
                ...
                <div className='edit-grid'>
                  <div className='edit-field'>
                    ...
                    <select
                      id='show-bookmarks'
                      value={showBookmarks}
                      onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setShowBookmarks(e.target.value)}
                    >
                  ...
                  <div className='edit-field'>
                    ...
                    <select id='gender' value={gender} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setGender(e.target.value)}>
          ...
          <div className='filters-bar'>
            ...
            <div className='filter-selects'>
              ...
              <select
                ...
                value={selectedGenre}
                onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setSelectedGenre(e.target.value)}
              >
