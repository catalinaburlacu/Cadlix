...
export default function UserProfileModal({ user: u, onClose }: UserProfileModalProps) {
  if (!u) return null
  return (
    <div className='admin-modal-overlay' onClick={onClose}>
      ...
      >
        ...
        <div className='admin-profile-header'>
          <img className='admin-profile-avatar' src={u.avatar} alt={u.username} />
