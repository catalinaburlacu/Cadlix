import { ALL_USERS } from '../../../../mocks/admin'
import StatCards from '../components/StatCards'
import type { ContentItem, ReportItem, AdminUser } from '@/types'
...
export default function AdminOverview({ contentList, reports, onNavigateToTab, onSelectUser }: AdminOverviewProps) {
            ...
            <tbody>
              {ALL_USERS.map(u => (
                ...
                >
                  ...
                  <td>
                    <span
                      className={`admin-status-dot admin-status-dot--${u.status.toLowerCase()}`}
                    >
                      {u.status}
                    </span>
                  </td>
