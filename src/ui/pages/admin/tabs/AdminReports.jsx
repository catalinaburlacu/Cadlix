export default function AdminReports({ reports, onResolve, onDismiss, onSelectReport }) {
      ...
      {reports.length === 0 ? (
        ...
        <div className="admin-table-wrap">
          <table className="admin-table">
            ...
            <tbody>
              {reports.map(rep => (
                <tr key={rep.id} className="admin-table-row--clickable" onClick={() => onSelectReport(rep)}>
